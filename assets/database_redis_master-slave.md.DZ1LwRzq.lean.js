import{_ as n,c as a,a2 as l,o as e}from"./chunks/framework.BDNoaL95.js";const m=JSON.parse('{"title":"主从复制","description":"","frontmatter":{},"headers":[],"relativePath":"database/redis/master-slave.md","filePath":"database/redis/master-slave.md","lastUpdated":1738670768000}'),p={name:"database/redis/master-slave.md"};function r(c,s,o,i,t,b){return e(),a("div",null,s[0]||(s[0]=[l(`<h1 id="主从复制" tabindex="-1">主从复制 <a class="header-anchor" href="#主从复制" aria-label="Permalink to &quot;主从复制&quot;">​</a></h1><p>配置文件</p><div class="language-sh line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki one-dark-pro vp-code" style="background-color:#282c34;color:#abb2bf;" tabindex="0"><code><span class="line"><span style="color:#61AFEF;">bind</span><span style="color:#D19A66;"> 0.0.0.0</span></span>
